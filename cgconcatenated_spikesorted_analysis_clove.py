...
def main():
    ...
    saveDir = Path('D:/Data/spkfigs/CLOVE/')
    neural_data = Path('E:\Electrophysiological_Data\F2105_Clove/')
    dp = Path('E:\ms4output\F2105_Clove/results_pykilosort_clove/recording_0/pykilosort/phy_folder')
