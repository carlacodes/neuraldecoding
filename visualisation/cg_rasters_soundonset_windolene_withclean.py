...
def target_vs_probe_with_raster(blocks, talker=1, probewords=[20, 22], pitchshift=True, stream = 'BB_3'):
    ...
    tarDir = Path(f'E:/rastersms4spikesortinginter/F1606_Windolene/figsonset2/{stream}/')
    saveDir = tarDir
    ...
    for cluster_id in clust_ids:
        ...
        try:
            ...
            plt.suptitle(f'Sound onset firings for windolene,  clus id '+ str(cluster_id) +'stream:'+ f'{stream}', fontsize = 12)
            plt.savefig(
...
def generate_rasters(dir):
    datapath = Path('E:\ms4output2\F1606_Windolene/011023_windolene_2020_05_31_noisereduc_2/011023_windolene_2020_05_31_noisereduc_2_011023_windolene_2020_05_31_noisereduc_2_BB_5\mountainsort4\phy/')
