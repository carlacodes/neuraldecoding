                ...
                for cond in [1,2,3,4,5]:
                    for i, clus in enumerate(scores[f'talker{talker}'][comp][cond]['cluster_id']):
                        ...
                        if clus in singleunitlist:
                            ...
                            if ferretname == 'Eclair':
                                scores_su[clus][talker][cond][probewordindex] = scores[f'talker{talker}'][comp][cond]['lstm_balanced_avg'][i]
                            else:
                                scores_su[clus][talker][cond][probewordindex] = np.mean(scores[f'talker{talker}'][comp][cond]['lstm_balancedaccuracylist'][i])
                            ...
                            if ferretname == 'Eclair':
                                scores_mu[clus][talker][cond][probewordindex] = scores[f'talker{talker}'][comp][cond]['lstm_balanced_avg'][i]
                            else:
                                scores_mu[clus][talker][cond][probewordindex] = np.mean(scores[f'talker{talker}'][comp][cond]['lstm_balancedaccuracylist'][i])
...
def plot_by_pitch(scores_mu_nala, scores_su_nala, scores_mu_cruella, scores_su_cruella, scores_mu_eclair,
    ...
    plt.savefig('D:/Data/decodingbypitchresults/LSTM_decoding_scores_by_pitch_female_balac.png', dpi=1000)
...
def plot_su_and_mu_by_pitch(female_array_zola_mu, female_array_zola_su, female_array_cruella_mu, female_array_cruella_su, female_array_eclair_mu, female_array_eclair_su, female_array_crumble_mu, female_array_crumble_su):
    ...
    plt.savefig('D:/Data/decodingbypitchresults/LSTM_decoding_scores_by_pitch_male_balac.png', dpi=1000)
