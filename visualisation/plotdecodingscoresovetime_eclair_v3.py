...
if __name__ == '__main__':
    ...
    big_folder = Path('G:/results_decodingovertime_17112023/F1902_Eclair/')
    ...
    for file_path in subfolders:
        for talker in talkerlist:
            ...
            plot_average_over_time(file_path, pitchshift, output_folder, ferretname, high_units, talkerinput = 'talker1', animal_id = animal, smooth_option=True)
