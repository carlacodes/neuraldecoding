...
def run_scores_and_plot(file_path, pitchshift, output_folder, ferretname,  stringprobewordindex=str(2), talker='female', totalcount = 0):
    if talker == 'female':
        ...
        talkerinput = 'talker2'
    scores = np.load(
        file_path + '/' + r'scores_' + ferretname + '_2022_' + stringprobewordindex + '_' + ferretname + '_probe_bs.npy',
        allow_pickle=True)[()]
...
if __name__ == '__main__':
    ...
    output_folder = 'D:\decodingresults_overtime\F1815_Cruella\lstm_kfold_balac_01092023_cruella/'
    ferretname = 'cruella'
    pitchshift = 'nopitchshift'
    stringprobewordlist = [2, 20, 5, 42, 32]
