...
def target_vs_probe_with_raster(blocks, talker=1, probewords=[20, 22], pitchshift=True, stream = 'BB_3'):
    ...
    tarDir = Path(f'E:/rastersms4spikesortinginter/F1812_Nala/figsonset2/{stream}/')
    saveDir = tarDir
    ...
    for cluster_id in clust_ids:
        ...
        try:
            ...
            plt.suptitle(f'Sound onset firings for nala,  clus id '+ str(cluster_id) +'stream:'+ f'{stream}', fontsize = 12)
            plt.savefig(
