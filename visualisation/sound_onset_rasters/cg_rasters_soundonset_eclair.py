...
def target_vs_probe_with_raster(blocks, talker=1, probewords=[20, 22], pitchshift=True, stream = 'BB_3'):
    ...
    tarDir = Path(f'E:/rastersms4spikesortinginter/F1902_Eclair/figsonset2/')
    saveDir = tarDir
...
def generate_rasters(dir):
    datapath = Path(f'E:\ms4output2\F1902_Eclair\Eclair_allblocks_29092023\Eclair_allblocks_30092023_Eclair_allblocks_30092023_BB_5\mountainsort4\phy/')
