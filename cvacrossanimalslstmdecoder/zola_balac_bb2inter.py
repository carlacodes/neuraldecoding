...
def run_classification(dir, datapath, ferretid):
    ...
    tarDir = Path(
        f'E:/results_04102023/F1702_Zola/bb2inter')
    saveDir = tarDir
...
def main():
    ...
    datapath = Path(
        f'E:/ms4output2/F1702_Zola/BB2BB3_zola_intertrialroving_26092023/BB2BB3_zola_intertrialroving_26092023_BB2BB3_zola_intertrialroving_26092023_BB_2/mountainsort4/phy/')
    ferretid = 'zola'
