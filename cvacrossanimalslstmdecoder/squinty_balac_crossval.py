...
from instruments.helpers.neural_analysis_helpers import get_word_aligned_raster, get_word_aligned_raster_squinty
...
def run_classification(dir, datapath, ferretid):
    ...
    scores = {}
    probewords_list = [2, 3, 4, 5, 7, 8, 9, 10, 11, 12, 14]
    ...
    for probeword in probewords_list:
        ...
        for talker in [1]:
            ...
            np.save(saveDir / f'scores_{dir}_{probeword}_{ferretid}_probe_bs.npy',
                    scores)
...
def main():
    directories = [
        'squinty_2022']  # , 'Trifle_July_2022']/home/zceccgr/Scratch/zceccgr/ms4output/F1702_cruella/spkenvresults04102022allrowsbut4th

    datapath = Path(
        f'E:\ms4output2\F1604_Squinty\BB2BB3_squinty_MYRIAD1_04092023\BB2BB3_squinty_MYRIAD1_14092023_BB2BB3_squinty_MYRIAD1_14092023_BB_2\mountainsort4\phy/')
    ferretid = 'squinty'
