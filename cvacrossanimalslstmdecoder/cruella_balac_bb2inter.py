...
def run_classification(dir, datapath, ferretid):
    ...
    tarDir = Path(
        f'E:/results_04102023/F1815_Cruella/bb2inter')
    saveDir = tarDir
...
def main():
    ...
    datapath = Path(
        f'E:\ms4output2\F1815_Cruella\BB2BB3_cruella_26092023\BB2BB3_cruella_26092023_BB2BB3_cruella_26092023_BB_2\mountainsort4\phy/')
    ferretid = 'cruella'
