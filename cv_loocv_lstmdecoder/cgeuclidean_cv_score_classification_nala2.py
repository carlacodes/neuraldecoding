...
def target_vs_probe(blocks, talker=1, probewords=[20, 22], pitchshift=True):
    ...
    for cluster_id in tqdm(clust_ids):
        ...
        accuracy_list = []
        bal_ac_list = []
        lpo = LeavePOut(p=len(stim_lstm) // 3)
...
def run_classification(dir, datapath, ferretid):
    ...
    tarDir = Path(f'/Users/cgriffiths/resultsms4/lstmclass_leavepoutDATA_09122022')
...
def main():
    directories = [
        'nala_2022']  # , 'Trifle_July_2022']/home/zceccgr/Scratch/zceccgr/ms4output/F1702_Zola/spkenvresults04102022allrowsbut4th
