...
def target_vs_probe(blocks, talker=1, probewords=[20, 22], pitchshift=True, window=[0, 0.5]):
    ...
    for cluster_id in tqdm(clust_ids):
        ...
        # try:
        raster_target, raster_targ_compare = get_word_aligned_raster(blocks, cluster_id, word=1,
        ...
        # try:
        raster_probe, raster_probe_compare = get_word_aligned_raster(blocks, cluster_id, word=probeword,
                                                                                  pitchshift=pitchshift,
                                                                                  correctresp=False,
                                                                                  df_filter=[])
...
def main():
    ...
    datapath = Path(
        f'D:\ms4output_16102023\F1702_Zola\BB2BB3zola2708_zola_27082021\BB2BB3zola2708_zola_27082021_BB2BB3zola2708_zola_27082021_BB_2\mountainsort4\phy')
    ferretid = 'zola'
